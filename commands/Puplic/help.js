...
module.exports = {
    ...
    run : (client, message, args) => {
      ...
      if (!Color) return;
            ...
            .setStyle('LINK')
            .setEmoji ('1366723495165165660')
            .setURL('https://discord.gg/dl1');
            ...
            const replyembed = new Discord.MessageEmbed()
                ...
                //   [أضغط للانتقال للمطور](https://discord.com/users/848675127427203133)
