...
module.exports = {
    ...
    run: async function(client, message) {
        ...
        const permissions = [
            { name: 'حظر وفك', value: 'ban', emoji: '1366723495165165660' },
            { name: 'الطرد', value: 'kick', emoji: '1366723495165165660' },
            { name: 'السجن', value: 'prison', emoji: '1366723495165165660' },
            { name: 'الأسكاتي الكتابي', value: 'mute', emoji: '1366723495165165660' },
            { name: 'الميوت الصوتي', value: 'vmute', emoji: '1366723495165165660' },
            { name: 'اعطاء إزالة رول', value: 'role', emoji: '1366723495165165660' },
            { name: 'اعطاء إزالة إنشاء, رول للجميع', value: 'allrole', emoji: '1366723495165165660' },
            { name: 'الرولات الخاصة', value: 'srole', emoji: '1366723495165165660' },
            { name: 'المسح', value: 'clear', emoji: '1366723495165165660' },
            { name: 'الصور ،الهير ،الكام', value: 'pic', emoji: '1366723495165165660' },
            { name: 'سحب ،ودني', value: 'move', emoji: '1366723495165165660' },
            { name: 'قفل فتح', value: 'lock', emoji: '1366723495165165660' },
            { name: 'اخفاء اظهار', value: 'hide', emoji: '1366723495165165660' },
            { name: 'معلومات الرول', value: 'check', emoji: '1366723495165165660' },
            { name: 'اوامر الانذارات', value: 'warn', emoji: '1366723495165165660' },
            { name: 'إزالة إضافة الكنية', value: 'setnick', emoji: '1366723495165165660' },
